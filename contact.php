...
<body>
    ...
    <div class="nav_bg">
        ...
        <div>
        <div style="height:500px; width:100%; margin:auto; margin-top:10px; margin-bottom:10px; background-color:#D3D3D3; border:2px solid red; box-shadow:4px 1px 20px black;">
            <form method="post" enctype="multipart/form-data">

            <h2 style="font-size:2.5em; text-align:center; color:#D50000; padding-right: 120px">Contact us</h2>
            <div class="col span_2_of_3"> <div class="contact-form" style="padding-left:650px;">
            ...
            <tr><td class="lefttd"  style="vertical-align:middle">Phone number</td><td><input type="number" name="t3"   pattern="[0-9]{10,12}" title="please enter only numbers between 10 to 12 for mobile no." /></td></tr>
            <tr><td class="lefttd"  style="vertical-align:middle">Subject</td><td><textarea name="t4"></textarea></td></tr>
            <tr><td>&nbsp;</td><td><input type="submit" value="Trimite" name="sbmt"></td></tr></table>
            </div>
        </div>
    </div>
    </form>
