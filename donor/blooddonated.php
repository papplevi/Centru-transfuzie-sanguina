...
<div style="height:400px; width:600px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#D3D3D3; border:2px solid red; box-shadow:4px 1px 20px black;">
	 <form method="post" enctype="multipart/form-data">

<h2 style="font-size:2.5em; text-align:center; color:#D50000; padding:20px">Donate blood</h2>
<table cellpadding="0" cellspacing="0" width="500px" class="tableborder" style="margin:auto" >
             <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
  
   <tr><td class="lefttd">Select centre </td><td><select name="s3" required><option value="">Select</option>
<?php
$cn=makeconnection();
$s="select * from camp";
