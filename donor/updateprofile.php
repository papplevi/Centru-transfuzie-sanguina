...
<div style="height:400px; width:700px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#D3D3D3; border:2px solid red; box-shadow:4px 1px 20px black;">
 <form method="post">

 
<h2 style="font-size:2.5em; text-align:center; color:#D50000; padding:20px">Update profile</h2>
    <table cellpadding="0" cellspacing="0" width="600px"  class="tableborder" style="margin:auto">

     <tr><td colspan="2">&nbsp;</td></tr>
     <table cellpadding="0" cellspacing="0" width="600px"  class="tableborder" style="margin:auto">
    <tr><td style="align='right'">&nbsp;</td><td><img src="../doner_pic/<?php echo @$pic; ?>" style="padding-left:40px"  width="400px" height="200px"/>
   ...
   <table cellpadding="0" cellspacing="0" width="450px" align="center" >
    <tr><td class="lefttd"  style="vertical-align:middle"> Name </td><td><input type="text" name="t1" value="<?php echo @$name;  ?>"  required="required" pattern="[a-zA-Z _]{5,15}" title="please enter only character  between 5 to 15 for  name" /></td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td class="lefttd">Gender</td><td><input name="r1" type="radio" value="female"  <?php if($gender=="female"){ echo "checked" ;}  ?>>Female<input name="r1" checked="checked" type="radio" value="male"/>Male</td></tr>
         <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
