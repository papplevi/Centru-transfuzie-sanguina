...
<div style="height:300px; width:1000px; margin:auto; margin-top:50px; margin-bottom:50px; background-color:#D3D3D3; border:2px solid red; box-shadow:4px 1px 20px black;">
     <form method="post" enctype="multipart/form-data">
     
<h2 style="font-size:2.5em; text-align:center; color:#D50000; padding:20px">Request for blood</h2>
